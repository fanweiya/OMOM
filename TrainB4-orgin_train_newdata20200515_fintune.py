...
trainPath = '/share_data/PRDATA/20200512_训练集_expand/20200512_训练集_fintune'
...
#model.summary()
'''
model=load_model('/share_data/PRDATA/fanweiya/CEST_weights/TrainB4-newdata/model_2020-05-26-02:38:16/smr_0_01_valacc_0.8597_valloss_0.4587.h5')
...
history=Model.fit_generator(train_generator,epochs=1,
                                   ...
                                   validation_data=validation_generator,use_multiprocessing = True,workers=256,
                                   validation_steps=totalVal // batch_size,class_weight='auto',
