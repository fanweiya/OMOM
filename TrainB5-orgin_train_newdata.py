...
efnet=EfficientNetB5(weights='/share_data/PRDATA/fanweiya/beifen/fanweiya/effictentet/efficientnet-b5_weights_tf_dim_ordering_tf_kernels_autoaugment_notop.h5',include_top=False,input_tensor=input_tensor)
...
#model.summary()
'''
model=load_model('/share_data/PRDATA/fanweiya/CEST_weights/TrainB4-newdata/model_2020-05-07-12:36:47/b5smr_0_04_valacc_0.8451_valloss_0.4088.h5')
'''
...
checkpoint = ParallelModelCheckpoint(model,filepath=weight_path+'/b5smr_{}'.format(label_smooh_rate)+'_{epoch:02d}_valacc_{val_acc:.4f}_valloss_{val_loss:.4f}.h5',monitor='val_loss',save_best_only=True,verbose=1)
...
'''
optimizers = RAdam(learning_rate=0.001)
