...
if __name__ == '__main__':
    ...
    img_augment = Rand_Augment()
    img_origal = Image.open('/share_data/xc_1205_dataset/train/chang-nei-rong-wu---xie-ye/1J031026491.jpg')
    for i in range(0, 10):
        print(type(img_origal))
        img_final = img_augment(img_origal)
        plt.subplot(5, 2, i + 1)
        plt.imshow(img_final)
        print(img_to_array(img_final))
    plt.show()
    print('how  to test')
...
#     )
# img = np.expand_dims(img_to_array(Image.open('/share_data/xc_1205_dataset/train/chang-nei-rong-wu---xie-ye/1J031026491.jpg')), axis=0)
# Flow = train_datagen.flow(img, batch_size=1,save_to_dir='/share_data/code/test',save_format="jpg")
# for i in range(19):
#     Flow.next()
