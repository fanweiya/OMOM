...
def EfficientNet(x,y,x_val,y_val,params):
    ...
    model.compile(loss='categorical_crossentropy',optimizer=params['optimizer'](lr=lr),metrics=['accuracy',top3_acc,'top_k_categorical_accuracy'])
