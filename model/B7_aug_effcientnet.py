...
def smooth_positive_labels(inputs,smooth_factor):
    ...
    return smooth_lable
label_smooh_rate=0.1
lr=3e-4
Num_epochs=50
backbone="EfficientNetB7_224_01label"
batch_size = 16
chnnel_number = 3
...
#lr_normalizer(params['lr'],params['optimizer']))
model.compile(loss='categorical_crossentropy',optimizer=optimizers.Adam(lr=lr),metrics=['accuracy',top3_acc,top5_acc])
