...
def EfficientNet(x,y,x_val,y_val,params):
    ...
    model=load_model('/share_data/code/weights_0.0_024_valacc_0.9012_valloss_0.3316.h5')
    img_height = img_width = model.get_layer(index=0).output_shape[1]
