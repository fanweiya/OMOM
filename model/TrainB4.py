...
from efficientnet.keras import EfficientNetB0,EfficientNetB1,EfficientNetB2,EfficientNetB4
import keras
...
pooling=GlobalMaxPooling2D()(efnet.output)
drop2=Dropout(0.2)(pooling)
