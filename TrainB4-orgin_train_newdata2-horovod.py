...
#model.summary()
'''
model=load_model('/root/CEST_weights/TrainB4-newdata/训练集CEST分类-20200320/model_2020-03-24-10:12:23/smr_0_01_valacc_0.7204_valloss_1.2570.h5')
'''
...
'''
optimizers = RAdam(learning_rate=lr_schedule(0))
#optimizers = optimizers.SGD(lr=lr_schedule(0),momentum = 0.9, nesterov = True)
opt = hvd.DistributedOptimizer(optimizers)
