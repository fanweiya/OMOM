...
#efnet=EfficientNetB3(weights='/root/fanweiya/efficientnet-b3_weights_tf_dim_ordering_tf_kernels_autoaugment_notop.h5',include_top=False,input_tensor=input_tensor)
efnet=load_model('/root/CEST_weights/TrainB3-new/smr_0_65_valacc_0.9410_valloss_0.3184.h5')
pooling=Flatten()(efnet.get_layer('top_activation').output)
...
ppmodel.compile(loss='categorical_crossentropy',optimizer=optimizers.SGD(lr=1e-3),metrics=['accuracy'])
