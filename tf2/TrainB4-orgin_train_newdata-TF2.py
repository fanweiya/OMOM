...
base_model=load_model('/share_data/CEST_weights/TrainB4-newdata/model_2020-03-24-10:12:23/smr_0_01_valacc_0.7204_valloss_1.2570.h5')
'''
...
Model.compile(loss=tf.keras.losses.CategoricalCrossentropy(label_smoothing=label_smooh_rate),
              optimizer=optimizers.SGD(lr=lr_schedule(0)*gpu_num,momentum = 0.9, nesterov = True),
              metrics=['accuracy'])
