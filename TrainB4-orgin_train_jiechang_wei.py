...
chnnel_number = 3
root='/share_data/XC_V1_expand_jiechang_wei'
...
weight_path=weight_path+'/model_'+'2020-02-18-16:29:49'
if not os.path.exists(weight_path):
    os.makedirs(weight_path)  
...
class_label=['阿弗他-无杂质', '阿弗他-杂质', '闭合结肠', '贲门+胃底', '贲门+胃体', '贲门+胃体+胃底', '典型贲门', '典型贲门+胃底', '典型贲门+胃底+胃体', '典型贲门+胃体', '典型胃角+胃窦', '典型胃角+胃体', '典型幽门小口', '多节结肠', '发红-像阿弗他', '光滑结肠', '光滑胃角', '过曝光', '盒子', '黑色肠液', '花朵超近', '环状结肠', '黄色黏膜', '回盲瓣+结肠', '浑浊过黑', '假幽门', '角结肠', '结肠', '结肠黏膜', '结节-非局灶-无杂质', '结节-非局灶-杂质', '结节-局灶-无杂质', '结节-局灶-杂质', '结节-无效', '结节息肉待审', '静脉异常隆起-有杂质', '溃疡-非局灶-有杂质', '溃疡-局灶-无杂质', '溃疡-局灶-杂质', '蓝色静脉-无杂质', '蓝色静脉-有杂质', '阑尾口', '脸', '糜烂-非局灶-伴随发红-无杂质', '糜烂-非局灶-伴随发红-有杂质', '糜烂-非局灶-无杂质', '糜烂-非局灶-杂质', '糜烂-局灶-暗黄色凹陷-无杂质', '糜烂-局灶-暗黄色凹陷-杂质', '糜烂-局灶-伴随发红-无杂质', '糜烂-局灶-伴随发红-有杂质', '糜烂-局灶-无杂质', '糜烂-局灶-杂质', '糜烂-类圆形-无杂质', '糜烂-类圆形-有杂质', '模糊', '黏膜水肿', '全白', '全黑', '三角超近结肠', '三角结肠', '食管', '手', '胃底+胃体上部腔', '胃底-超近景', '胃底-粗褶皱近', '胃底-粗褶皱远', '胃底-近景', '胃底-弯曲细褶皱', '胃底-细褶皱', '胃底-远景', '胃底黏膜', '胃底未充盈', '胃窦+胃体（2）', '胃窦+幽门', '胃窦-半腔', '胃窦-半腔-收缩环', '胃窦-半收缩环-近景', '胃窦-半收缩环-远景', '胃窦-闭合', '胃窦-超近景', '胃窦-放射条-近景', '胃窦-放射条-远景', '胃窦-花朵状-近景', '胃窦-花朵状-远景', '胃窦-近景', '胃窦-腔', '胃窦-全收缩环-近景', '胃窦-全收缩环-远景', '胃窦-条状', '胃窦-外腔', '胃窦-无特征腔', '胃窦-星状', '胃窦-杂乱褶皱', '胃窦-褶皱', '胃窦-褶皱腔', '胃窦环', '胃窦环超近', '胃窦假环', '胃窦黏膜', '胃窦小花', '胃窦朝胃体', '胃角+胃窦', '胃角+胃体', '胃角超近景', '胃角光滑前后壁', '胃角前后壁+胃窦', '胃角前后壁+胃体', '胃角区+胃窦', '胃角无特征-前后壁', '胃角褶皱前后壁', '胃体+胃角+胃窦', '胃体-超近褶皱', '胃体-近景', '胃体-平行褶皱', '胃体-上部半腔', '胃体-上部全腔', '胃体-上部褶皱', '胃体-收缩环', '胃体-条状', '胃体-弯曲细褶皱', '胃体-下部腔', '胃体-小弯粗褶皱-近', '胃体-小弯光滑-近', '胃体-小弯光滑前后壁', '胃体-小弯远景', '胃体-小弯褶皱前后壁', '胃体-中下部腔', '胃体超近景', '胃体超近景黏膜', '胃体静脉', '胃体黏膜', '胃体未充盈-近', '胃体未充盈-远', '胃体朝胃底', '胃体朝胃窦', '胃体中下部腔-胃窦', '无效1', '无效10', '无效11', '无效12', '无效13', '无效14', '无效15', '无效17', '无效18', '无效19', '无效2', '无效3', '无效4', '无效5', '无效6', '无效7', '无效8', '无效9', '无效_多残渣', '无效_多水泡', '无效_过浑浊', '无效_过曝光', '无效_一半结肠一半粪便', '息肉-非局灶', '息肉-局灶', '下部收缩环褶皱', '下部条状褶皱', '下部胃体收缩环', '下部胃体收缩环褶皱', '小口闭合环', '小口收缩环', '小弯光滑', '血块-黑色', '血块-红色', '血液-非局灶-暗红色', '血液-非局灶-黑绿色', '血液-非局灶-红色', '血液-非局灶-红色血渣', '血液-局灶-红色', '血液-局灶血丝', '血液-无效', '衣服', '幽门+小肠', '幽门-半口', '幽门-不明显小口', '幽门-像胃窦', '幽门-正对小口', '幽门大口-杂质', '幽门小口+杂质', '幽门小口闭合', '幽门星口', '幽门圆', '幽门圆口', '杂质-其他', '杂质-水泡', '褶皱结肠', '正常-翻折发白', '正常-无杂质-红色静脉', '正常-无杂质-黏膜红色', '正常-无杂质-绒毛', '正常-无杂质-绒毛颗粒', '正常-杂质-红色静脉', '正常-杂质-黄白漂浮物', '正常-杂质-灰蓝色静脉', '正常-杂质-弥散漂浮物', '正常-杂质-水泡', '肿块(肿瘤)-伴随发红-有杂质', '肿块(肿瘤)-局灶-无杂质', '肿块(肿瘤)-局灶-有杂质', '肿块(肿瘤)-疑似-无杂质', '肿块(肿瘤)-疑似-杂质']
...
model.summary()
'''
model=load_model('/root/CEST_weights/TrainB4-newdata/model_2020-02-18-16:29:49/jc_smr_0_05_valacc_0.8170_valloss_0.6763.h5')
...
history=Model.fit_generator(train_generator,epochs=Num_epochs,
                                   ...
                                   validation_steps=totalVal // batch_size,
                                   use_multiprocessing = True,workers=128,
                                   verbose=1,callbacks=cbks)
